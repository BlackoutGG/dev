<template>
  <section id="home">
    ...
    <v-container dark class="pa-0" fluid>
      ...
      <!-- </div> -->
      <info-block :data="blocks[0]" :idx="0" />
      ...
      items: [
        {
          title: 'Albion Online',
          src:
            'https://blackout-gaming.s3.amazonaws.com/Images/slides/fullscreen/albion.jpg',
          justify: 'center',
          text: `<p>
        ...
        },
        {
          title: 'Starbase',
          src:
            'https://blackout-gaming.s3.amazonaws.com/Images/slides/fullscreen/starbase.jpg',
          justify: 'end',
          text: `<p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Nam eu lorem eu turpis tincidunt convallis ac et lorem.
        ...
        },
        {
          title: 'Last Oasis',
          src:
            'https://blackout-gaming.s3.amazonaws.com/Images/slides/fullscreen/lastoasis.jpg',
          text: `<p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Nam eu lorem eu turpis tincidunt convallis ac et lorem.
                        Pellentesque scelerisque nunc in enim rhoncus, quis
        ...
        },
        {
          ...
          src:
            'https://blackout-gaming.s3.amazonaws.com/Images/slides/fullscreen/newworld.jpg',
          text: `<p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Nam eu lorem eu turpis tincidunt convallis ac et lorem.
                        Pellentesque scelerisque nunc in enim rhoncus, quis
        ...
        },
        {
          ...
          src:
            'https://blackout-gaming.s3.amazonaws.com/Images/slides/fullscreen/lif.jpg',
          text: `<p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Nam eu lorem eu turpis tincidunt convallis ac et lorem.
                        Pellentesque scelerisque nunc in enim rhoncus, quis
      ...
      blocks: [
        {
          ...
          image: {
            src:
              'https://blackout-gaming.s3.amazonaws.com/Images/slides/about/bko.png',
            widthInPx: 700,
            heightInPx: 363,
          },
        },
