  ...
  methods: {
    ...
    genRadios(_props) {
      ...
      const radio = (option) => {
        ...
        return this.$createElement(VRadio, { props: radioProps }, []);
      };
    ...
    genSelect(_props) {
      ...
      return this.$createElement(VSelect, { props, on });
    },
    ...
    genInputField(input, _props) {
      ...
      return this.$createElement(
        input === 'textarea' ? VTextarea : VTextField,
        { props, on },
        []
      );
    },
    ...
    genField(props) {
      switch (this.field.type) {
        ...
        case 'textarea':
          return this.genInputField('textarea', props);
        default:
          return this.genInputField('textfield', props);
      }
    },
  },
