...
import tabletypes from '~/components/table/store/types/public';
  ...
  async [types.actions.FETCH]({ commit, getters, state }, categories) {
    ...
    try {
      ...
      if (categories && categories.length) {
        commit(tabletypes.mutations.SET_TYPE, 'categories', { root: true });
        commit(tabletypes.mutations.SET_LIST, categories, { root: true });
      }
