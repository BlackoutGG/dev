...
import state from '~/components/table/store/state';
import getters from '~/components/table/store/getters';
import mutations from '~/components/table/store/mutations';
import actions from '~/components/table/store/actions';
