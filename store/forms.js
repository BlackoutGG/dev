...
import state from '~/components/forms/store/state';
import getters from '~/components/forms/store/getters';
import mutations from '~/components/forms/store/mutations';
import actions from '~/components/forms/store/actions';
